        ...
        <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.6)', zIndex:1000, display:'flex', alignItems:'center', justifyContent:'center' }}
          ...
          <div style={{ background:'var(--surface1)', borderRadius:10, width:'min(360px,90vw)', maxHeight:'70vh', display:'flex', flexDirection:'column', overflow:'hidden' }}
            ...
            <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'14px 16px', borderBottom:'1px solid var(--border)' }}>
              <span style={{ fontWeight:700, fontSize:14, color:'var(--text1)' }}>{listModal === 'followers' ? 'Followers' : 'Following'}</span>
              ...
              {listUsers.map(u => {
                ...
                return (
                  <div key={u.id} onClick={() => goToUser(u)}
                    ...
                    <div>
                      <div style={{ fontSize:13, fontWeight:600, color:'var(--text1)' }}>{name}</div>
